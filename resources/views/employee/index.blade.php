    ...
    <div class="content">
        ...
        <div class="row">
                ...
                <div class="card-footer ">
                 <button type="submit" class="btn col-12" style="background-color: #A020F0; color: white;">Submit</button>
                    ...
                    <table class="table table-bordered table-stiped fs-1 text-black">
                        ...
                        <tbody  >
                            ...
                            <tr>
                                ...
                                <td>{{$items->zip}}</td>
                                <td> 
                                    <span class="badge bg-dark"><a href="{{  route('employee.edit',$items->id)}}" class="btn btn-dark mx-3  "><h5>Edit</h5></a></span>
                                </td>
                                <td> 
                                    
                                <span class="badge" style="background-color: #6f42c1;"><a href="{{  route('employee.delete',$items->id)}}" class="m-3 p-lg-5"  style="color: white; text-decoration: none;"><h5>Delete</h5></a></span>
                                </td>
